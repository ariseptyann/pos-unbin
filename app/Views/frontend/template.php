      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item">
                <a class="navbar-brand" href="<?= site_url('/home/kasir') ?>">
            ...
            <ul class="nav navbar-nav float-right">         
              <li class="dropdown dropdown-user nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <a class="dropdown-item" href="/home/logout"><i class="ft-power"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
                                ...
                                <div class="col-6">
                                  ...
                                  <div class="modal fade text-left" id="pembayaranModal" tabindex="-1" role="dialog" aria-labelledby="pembayaran" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <form action="<?= site_url('/home/payment') ?>" method="post" class="category-content" id="payment">
